...
use chrono::Local;
use log::LevelFilter; // Off, Error, Warn, Info, Debug, Trace
...
pub fn rudra_error_and_exit(msg: impl AsRef<str>) -> ! {
    progress_error!("Fatal error in Rudra: {}", msg.as_ref());
    std::process::exit(1);
}
